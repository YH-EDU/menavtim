...
export default function Landing() {
  return (
    <HeroBg image="/lomdim-aramit/bg-landing.webp">
      <div
        style={{
          minHeight: '100vh',
          display: 'flex',
      ...
      >
        <div className="pop-in" style={{ textAlign: 'center', color: '#fff', marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 38, fontWeight: 900, textShadow: '0 2px 14px rgba(0,0,0,0.4)' }}>לומדים ארמית</h1>
          <p style={{ fontSize: 19, opacity: 0.95, maxWidth: 480, margin: '10px auto 0', lineHeight: 1.6, textShadow: '0 1px 8px rgba(0,0,0,0.35)' }}>
            מסע משחקי לדוברי עברית — ממילים יומיומיות ועד ביטויים תלמודיים, צעד אחר צעד
          </p>
        </div>
