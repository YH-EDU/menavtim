 ...
 */var jf;function Bv(){if(jf)return at;jf=1;var a=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),s=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),d=Symbol.for("react.memo"),m=Symbol.for("react.lazy"),v=Symbol.iterator;function _(w){return w===null||typeof w!="object"?null:(w=v&&w[v]||w["@@iterator"],typeof w=="function"?w:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,R={};function x(w,G,T){this.props=w,this.context=G,this.refs=R,this.updater=T||y}x.prototype.isReactComponent={},x.prototype.setState=function(w,G){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,G,"setState")},x.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function C(){}C.prototype=x.prototype;function M(w,G,T){this.props=w,this.context=G,this.refs=R,this.updater=T||y}var S=M.prototype=new C;S.constructor=M,b(S,x.prototype),S.isPureReactComponent=!0;var j=Array.isArray,z=Object.prototype.hasOwnProperty,I={current:null},O={key:!0,ref:!0,__self:!0,__source:!0};function te(w,G,T){var A,B={},$=null,k=null;if(G!=null)for(A in G.ref!==void 0&&(k=G.ref),G.key!==void 0&&($=""+G.key),G)z.call(G,A)&&!O.hasOwnProperty(A)&&(B[A]=G[A]);var Q=arguments.length-2;if(Q===1)B.children=T;else if(1<Q){for(var ue=Array(Q),fe=0;fe<Q;fe++)ue[fe]=arguments[fe+2];B.children=ue}if(w&&w.defaultProps)for(A in Q=w.defaultProps,Q)B[A]===void 0&&(B[A]=Q[A]);return{$$typeof:a,type:w,key:$,ref:k,props:B,_owner:I.current}}function K(w,G){return{$$typeof:a,type:w.type,key:G,ref:w.ref,props:w.props,_owner:w._owner}}function Z(w){return typeof w=="object"&&w!==null&&w.$$typeof===a}function le(w){var G={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(T){return G[T]})}var F=/\/+/g;function ae(w,G){return typeof w=="object"&&w!==null&&w.key!=null?le(""+w.key):G.toString(36)}function ne(w,G,T,A,B){var $=typeof w;($==="undefined"||$==="boolean")&&(w=null);var k=!1;if(w===null)k=!0;else switch($){case"string":case"number":k=!0;break;case"object":switch(w.$$typeof){case a:case e:k=!0}}if(k)return k=w,B=B(k),w=A===""?"."+ae(k,0):A,j(B)?(T="",w!=null&&(T=w.replace(F,"$&/")+"/"),ne(B,G,T,"",function(fe){return fe})):B!=null&&(Z(B)&&(B=K(B,T+(!B.key||k&&k.key===B.key?"":(""+B.key).replace(F,"$&/")+"/")+w)),G.push(B)),1;if(k=0,A=A===""?".":A+":",j(w))for(var Q=0;Q<w.length;Q++){$=w[Q];var ue=A+ae($,Q);k+=ne($,G,T,ue,B)}else if(ue=_(w),typeof ue=="function")for(w=ue.call(w),Q=0;!($=w.next()).done;)$=$.value,ue=A+ae($,Q++),k+=ne($,G,T,ue,B);else if($==="object")throw G=String(w),Error("Objects are not valid as a React child (found: "+(G==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":G)+"). If you meant to render a collection of children, use an array instead.");return k}function pe(w,G,T){if(w==null)return w;var A=[],B=0;return ne(w,A,"","",function($){return G.call(T,$,B++)}),A}function Ee(w){if(w._status===-1){var G=w._result;G=G(),G.then(function(T){(w._status===0||w._status===-1)&&(w._status=1,w._result=T)},function(T){(w._status===0||w._status===-1)&&(w._status=2,w._result=T)}),w._status===-1&&(w._status=0,w._result=G)}if(w._status===1)return w._result.default;throw w._result}var ie={current:null},V={transition:null},q={ReactCurrentDispatcher:ie,ReactCurrentBatchConfig:V,ReactCurrentOwner:I};function N(){throw Error("act(...) is not supported in production builds of React.")}return at.Children={map:pe,forEach:function(w,G,T){pe(w,function(){G.apply(this,arguments)},T)},count:function(w){var G=0;return pe(w,function(){G++}),G},toArray:function(w){return pe(w,function(G){return G})||[]},only:function(w){if(!Z(w))throw Error("React.Children.only expected to receive a single React element child.");return w}},at.Component=x,at.Fragment=n,at.Profiler=s,at.PureComponent=M,at.StrictMode=i,at.Suspense=p,at.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=q,at.act=N,at.cloneElement=function(w,G,T){if(w==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+w+".");var A=b({},w.props),B=w.key,$=w.ref,k=w._owner;if(G!=null){if(G.ref!==void 0&&($=G.ref,k=I.current),G.key!==void 0&&(B=""+G.key),w.type&&w.type.defaultProps)var Q=w.type.defaultProps;for(ue in G)z.call(G,ue)&&!O.hasOwnProperty(ue)&&(A[ue]=G[ue]===void 0&&Q!==void 0?Q[ue]:G[ue])}var ue=arguments.length-2;if(ue===1)A.children=T;else if(1<ue){Q=Array(ue);for(var fe=0;fe<ue;fe++)Q[fe]=arguments[fe+2];A.children=Q}return{$$typeof:a,type:w.type,key:B,ref:$,props:A,_owner:k}},at.createContext=function(w){return w={$$typeof:c,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},w.Provider={$$typeof:l,_context:w},w.Consumer=w},at.createElement=te,at.createFactory=function(w){var G=te.bind(null,w);return G.type=w,G},at.createRef=function(){return{current:null}},at.forwardRef=function(w){return{$$typeof:f,render:w}},at.isValidElement=Z,at.lazy=function(w){return{$$typeof:m,_payload:{_status:-1,_result:w},_init:Ee}},at.memo=function(w,G){return{$$typeof:d,type:w,compare:G===void 0?null:G}},at.startTransition=function(w){var G=V.transition;V.transition={};try{w()}finally{V.transition=G}},at.unstable_act=N,at.useCallback=function(w,G){return ie.current.useCallback(w,G)},at.useContext=function(w){return ie.current.useContext(w)},at.useDebugValue=function(){},at.useDeferredValue=function(w){return ie.current.useDeferredValue(w)},at.useEffect=function(w,G){return ie.current.useEffect(w,G)},at.useId=function(){return ie.current.useId()},at.useImperativeHandle=function(w,G,T){return ie.current.useImperativeHandle(w,G,T)},at.useInsertionEffect=function(w,G){return ie.current.useInsertionEffect(w,G)},at.useLayoutEffect=function(w,G){return ie.current.useLayoutEffect(w,G)},at.useMemo=function(w,G){return ie.current.useMemo(w,G)},at.useReducer=function(w,G,T){return ie.current.useReducer(w,G,T)},at.useRef=function(w){return ie.current.useRef(w)},at.useState=function(w){return ie.current.useState(w)},at.useSyncExternalStore=function(w,G,T){return ie.current.useSyncExternalStore(w,G,T)},at.useTransition=function(){return ie.current.useTransition()},at.version="18.3.1",at}var Wf;function hd(){return Wf||(Wf=1,vc.exports=Bv()),vc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qf;function Vv(){return qf||(qf=1,(function(a){function e(V,q){var N=V.length;V.push(q);e:for(;0<N;){var w=N-1>>>1,G=V[w];if(0<s(G,q))V[w]=q,V[N]=G,N=w;else break e}}function n(V){return V.length===0?null:V[0]}function i(V){if(V.length===0)return null;var q=V[0],N=V.pop();if(N!==q){V[0]=N;e:for(var w=0,G=V.length,T=G>>>1;w<T;){var A=2*(w+1)-1,B=V[A],$=A+1,k=V[$];if(0>s(B,N))$<G&&0>s(k,B)?(V[w]=k,V[$]=N,w=$):(V[w]=B,V[A]=N,w=A);else if($<G&&0>s(k,N))V[w]=k,V[$]=N,w=$;else break e}}return q}function s(V,q){var N=V.sortIndex-q.sortIndex;return N!==0?N:V.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;a.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();a.unstable_now=function(){return c.now()-f}}var p=[],d=[],m=1,v=null,_=3,y=!1,b=!1,R=!1,x=typeof setTimeout=="function"?setTimeout:null,C=typeof clearTimeout=="function"?clearTimeout:null,M=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(V){for(var q=n(d);q!==null;){if(q.callback===null)i(d);else if(q.startTime<=V)i(d),q.sortIndex=q.expirationTime,e(p,q);else break;q=n(d)}}function j(V){if(R=!1,S(V),!b)if(n(p)!==null)b=!0,Ee(z);else{var q=n(d);q!==null&&ie(j,q.startTime-V)}}function z(V,q){b=!1,R&&(R=!1,C(te),te=-1),y=!0;var N=_;try{for(S(q),v=n(p);v!==null&&(!(v.expirationTime>q)||V&&!le());){var w=v.callback;if(typeof w=="function"){v.callback=null,_=v.priorityLevel;var G=w(v.expirationTime<=q);q=a.unstable_now(),typeof G=="function"?v.callback=G:v===n(p)&&i(p),S(q)}else i(p);v=n(p)}if(v!==null)var T=!0;else{var A=n(d);A!==null&&ie(j,A.startTime-q),T=!1}return T}finally{v=null,_=N,y=!1}}var I=!1,O=null,te=-1,K=5,Z=-1;function le(){return!(a.unstable_now()-Z<K)}function F(){if(O!==null){var V=a.unstable_now();Z=V;var q=!0;try{q=O(!0,V)}finally{q?ae():(I=!1,O=null)}}else I=!1}var ae;if(typeof M=="function")ae=function(){M(F)};else if(typeof MessageChannel<"u"){var ne=new MessageChannel,pe=ne.port2;ne.port1.onmessage=F,ae=function(){pe.postMessage(null)}}else ae=function(){x(F,0)};function Ee(V){O=V,I||(I=!0,ae())}function ie(V,q){te=x(function(){V(a.unstable_now())},q)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(V){V.callback=null},a.unstable_continueExecution=function(){b||y||(b=!0,Ee(z))},a.unstable_forceFrameRate=function(V){0>V||125<V?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<V?Math.floor(1e3/V):5},a.unstable_getCurrentPriorityLevel=function(){return _},a.unstable_getFirstCallbackNode=function(){return n(p)},a.unstable_next=function(V){switch(_){case 1:case 2:case 3:var q=3;break;default:q=_}var N=_;_=q;try{return V()}finally{_=N}},a.unstable_pauseExecution=function(){},a.unstable_requestPaint=function(){},a.unstable_runWithPriority=function(V,q){switch(V){case 1:case 2:case 3:case 4:case 5:break;default:V=3}var N=_;_=V;try{return q()}finally{_=N}},a.unstable_scheduleCallback=function(V,q,N){var w=a.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?w+N:w):N=w,V){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=N+G,V={id:m++,callback:q,priorityLevel:V,startTime:N,expirationTime:G,sortIndex:-1},N>w?(V.sortIndex=N,e(d,V),n(p)===null&&V===n(d)&&(R?(C(te),te=-1):R=!0,ie(j,N-w))):(V.sortIndex=G,e(p,V),b||y||(b=!0,Ee(z))),V},a.unstable_shouldYield=le,a.unstable_wrapCallback=function(V){var q=_;return function(){var N=_;_=q;try{return V.apply(this,arguments)}finally{_=N}}}})(yc)),yc}var Kf;function jv(){return Kf||(Kf=1,xc.exports=Vv()),xc.exports}/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})})(l,e,n)}return s}_compileMaterial(e){const n=new Wn(this._lodPlanes[0],e);this._renderer.compile(n,Xc)}_sceneToCubeUV(e,n,i,s){const l=new Dn(90,1,n,i),c=[1,-1,1,1,1,1],f=[1,1,1,-1,-1,-1],p=this._renderer,d=p.autoClear,m=p.toneMapping;p.getClearColor(Wp),p.toneMapping=_i,p.autoClear=!1;const v=new Ul({name:"PMREM.Background",side:Mn,depthWrite:!1,depthTest:!1}),_=new Wn(new Ys,v);let y=!1;const b=e.background;b?b.isColor&&(v.color.copy(b),e.background=null,y=!0):(v.color.copy(Wp),y=!0);for(let R=0;R<6;R++){const x=R%3;x===0?(l.up.set(0,c[R],0),l.lookAt(f[R],0,0)):x===1?(l.up.set(0,0,c[R]),l.lookAt(0,f[R],0)):(l.up.set(0,c[R],0),l.lookAt(0,0,f[R]));const C=this._cubeSize;_l(s,x*C,R>2?C:0,C,C),p.setRenderTarget(s),y&&p.render(_,l),p.render(e,l)}_.geometry.dispose(),_.material.dispose(),p.toneMapping=m,p.autoClear=d,e.background=b}_textureToCubeUV(e,n){const i=this._renderer,s=e.mapping===qa||e.mapping===Ka;s?(this._cubemapMaterial===null&&(this._cubemapMaterial=$p()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Kp());const l=s?this._cubemapMaterial:this._equirectMaterial,c=new Wn(this._lodPlanes[0],l);l.uniforms.envMap.value=e;const f=this._cubeSize;_l(n,0,0,3*f,2*f),i.setRenderTarget(n),i.render(c,Xc)}_applyPMREM(e){const n=this._renderer,i=n.autoClear;n.autoClear=!1;for(let s=1;s<this._lodPlanes.length;s++){const l=Math.sqrt(this._sigmas[s]*this._sigmas[s]-this._sigmas[s-1]*this._sigmas[s-1]),c=Xp[(s-1)%Xp.length];this._blur(e,s-1,s,l,c)}n.autoClear=i}_blur(e,n,i,s,l){const c=this._pingPongRenderTarget;this._halfBlur(e,c,n,i,s,"latitudinal",l),this._halfBlur(c,e,i,i,s,"longitudinal",l)}_halfBlur(e,n,i,s,l,c,f){const p=this._renderer,d=this._blurMaterial;c!=="latitudinal"&&c!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const m=new Wn(this._lodPlanes[s],d),v=d.uniforms,_=this._sizeLods[i]-1,y=isFinite(l)?Math.PI/(2*_):2*Math.PI/39,b=l/y,R=isFinite(l)?1+Math.floor(3*b):Bs;R>Bs&&console.warn(`sigmaRadians, ${l}, is too large and will clip, as it requested ${R} samples when the maximum is set to 20`);const x=[];let C=0;for(let j=0;j<Bs;++j){const z=j/b,I=Math.exp(-z*z/2);x.push(I),j===0?C+=I:j<R&&(C+=2*I)}for(let j=0;j<x.length;j++)x[j]=x[j]/C;v.envMap.value=e.texture,v.samples.value=R,v.weights.value=x,v.latitudinal.value=c==="latitudinal",f&&(v.poleAxis.value=f);const{_lodMax:M}=this;v.dTheta.value=y,v.mipInt.value=M-i;const S=this._sizeLods[s];_l(n,3*S*(s>M-4?s-M+4:0),4*(this._cubeSize-S),3*S,2*S),p.setRenderTarget(n),p.render(m,Xc)}}function qp(a,e,n){const i=new Zi(a,e,n);return i.texture.mapping=Ll,i.texture.name="PMREM.cubeUv",i.scissorTest=!0,i}function _l(a,e,n,i,s){a.viewport.set(e,n,i,s),a.scissor.set(e,n,i,s)}function Kp(){return new Ji({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sd(),fragmentShader:`
